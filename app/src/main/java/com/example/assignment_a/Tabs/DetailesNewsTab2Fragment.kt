...
class DetailesNewsTab2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View= inflater.inflate(R.layout.fragment_detailes_news_tab2, container, false)
        ...
        val retrofitData=retrofit.getDetailNews(tagName[0],API_KEY)
        ...
        retrofitData.enqueue(object :Callback<newsDataClass>{
            override fun onResponse(p0: Call<newsDataClass>, response: Response<newsDataClass>) {
                ...
                val recyclerView=view.findViewById<RecyclerView>(R.id.detailNewsRecyclerview)
